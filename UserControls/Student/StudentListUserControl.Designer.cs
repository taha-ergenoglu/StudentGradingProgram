namespace StudentGradingProgram.UserControls.Student
{
    partial class StudentListUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            guna2ShadowPanel3.Controls.Add(StudentListDataGrid);
            guna2ShadowPanel3.Dock = DockStyle.Fill;
            guna2ShadowPanel3.FillColor = Color.White;
            guna2ShadowPanel3.Location = new Point(278, 0);
            guna2ShadowPanel3.Name = "guna2ShadowPanel3";
            guna2ShadowPanel3.Padding = new Padding(15);
            guna2ShadowPanel3.Radius = 5;
            guna2ShadowPanel3.ShadowColor = Color.Black;
            guna2ShadowPanel3.Size = new Size(905, 860);
            guna2ShadowPanel3.TabIndex = 1;
            // 
            // StudentListDataGrid
            // 
            StudentListDataGrid.AllowUserToResizeColumns = false;
            StudentListDataGrid.AllowUserToResizeRows = false;
            dataGridViewCellStyle1.BackColor = Color.White;
            StudentListDataGrid.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle1;
            ...
            StudentListDataGrid.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle2;
            StudentListDataGrid.ColumnHeadersHeight = 15;
            StudentListDataGrid.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.EnableResizing;
            ...
            StudentListDataGrid.DefaultCellStyle = dataGridViewCellStyle3;
            StudentListDataGrid.Dock = DockStyle.Fill;
            StudentListDataGrid.GridColor = Color.FromArgb(231, 229, 255);
            StudentListDataGrid.Location = new Point(15, 15);
            StudentListDataGrid.Name = "StudentListDataGrid";
            StudentListDataGrid.ReadOnly = true;
            StudentListDataGrid.RowHeadersVisible = false;
            StudentListDataGrid.ShowEditingIcon = false;
            StudentListDataGrid.Size = new Size(875, 830);
            StudentListDataGrid.TabIndex = 0;
            StudentListDataGrid.ThemeStyle.AlternatingRowsStyle.BackColor = Color.White;
            StudentListDataGrid.ThemeStyle.AlternatingRowsStyle.Font = null;
            StudentListDataGrid.ThemeStyle.AlternatingRowsStyle.ForeColor = Color.Empty;
            StudentListDataGrid.ThemeStyle.AlternatingRowsStyle.SelectionBackColor = Color.Empty;
            StudentListDataGrid.ThemeStyle.AlternatingRowsStyle.SelectionForeColor = Color.Empty;
            StudentListDataGrid.ThemeStyle.BackColor = Color.White;
            StudentListDataGrid.ThemeStyle.GridColor = Color.FromArgb(231, 229, 255);
            StudentListDataGrid.ThemeStyle.HeaderStyle.BackColor = Color.FromArgb(100, 88, 255);
            StudentListDataGrid.ThemeStyle.HeaderStyle.BorderStyle = DataGridViewHeaderBorderStyle.None;
            StudentListDataGrid.ThemeStyle.HeaderStyle.Font = new Font("Segoe UI", 9F);
            StudentListDataGrid.ThemeStyle.HeaderStyle.ForeColor = Color.White;
            StudentListDataGrid.ThemeStyle.HeaderStyle.HeaightSizeMode = DataGridViewColumnHeadersHeightSizeMode.EnableResizing;
            StudentListDataGrid.ThemeStyle.HeaderStyle.Height = 15;
            StudentListDataGrid.ThemeStyle.ReadOnly = true;
            StudentListDataGrid.ThemeStyle.RowsStyle.BackColor = Color.White;
            StudentListDataGrid.ThemeStyle.RowsStyle.BorderStyle = DataGridViewCellBorderStyle.SingleHorizontal;
            StudentListDataGrid.ThemeStyle.RowsStyle.Font = new Font("Segoe UI", 9F);
            StudentListDataGrid.ThemeStyle.RowsStyle.ForeColor = Color.FromArgb(71, 69, 94);
            StudentListDataGrid.ThemeStyle.RowsStyle.Height = 25;
            StudentListDataGrid.ThemeStyle.RowsStyle.SelectionBackColor = Color.FromArgb(231, 229, 255);
            StudentListDataGrid.ThemeStyle.RowsStyle.SelectionForeColor = Color.FromArgb(71, 69, 94);
        ...
        private Guna.UI2.WinForms.Guna2ShadowPanel FilterPanel;
